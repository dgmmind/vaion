...
$users = [
    "MGR001" => [
        ...
        "role" => "admin",
        "employees" => [
            [ "id" => "04394", "name" => "EVELIN DANIELA OSEGUERA AGUILAR", "username" => "eaguilar", "password" => "eaguilar1", "status" => "active", "role" => "user" ],
    ...
    "MGR003" => [
        ...
        "employees" => [
            ...
            [ "id" => "03487", "name" => "KENIA ISABEL ZAMBRANO MOLINA", "username" => "kmolina", "password" => "kmolina1", "status" => "active", "role" => "user" ],
            ...
            [ "id" => "23863", "name" => "ANDRE ALEXANDER GARCIA LAINEZ", "username" => "alainez", "password" => "alainez1", "status" => "active", "role" => "user" ],
            [ "id" => "10716", "name" => "ALEJANDRO JOSE SALGADO GIRON", "username" => "agiron", "password" => "agiron1", "status" => "active", "role" => "user" ],
            [ "id" => "07986", "name" => "GERSON ENOC ZUNIGA CHANG", "username" => "gchang", "password" => "gchang1", "status" => "active", "role" => "user" ],
            [ "id" => "12345", "name" => "LUIS EDUARDO ROJAS ESCALA", "username" => "lescala", "password" => "lescala1", "status" => "active", "role" => "user" ]
        ]
    ],
    "MGR004" => [
    "id" => "00731",
