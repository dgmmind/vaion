...
?>
  ...
  <main class="main-content">
    <div class="container card">
      ...
      <form method="POST" action="api.php?action=create_day" style="margin-top: 20px;">
          <div style="margin-bottom: 15px;">
              <label style="display: block; margin-bottom: 5px; font-weight: 500;">Day Date:</label>
              <input type="date" name="day_date" required style="padding: 8px; border: 1px solid #d1d5db; border-radius: 4px; width: 200px;">
          </div>
